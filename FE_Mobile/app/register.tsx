...
export default function RegisterScreen() {
  ...
  const handleRegister = () => {
    ...
    if (!accepted) {
      Alert.alert("Điều khoản", "Vui lòng xác nhận điều khoản sử dụng.");
      return;
    }

    Alert.alert("Đăng ký", "Form đã sẵn sàng để kết nối API tạo tài khoản.");
  };
        ...
        >
          ...
          <View style={styles.form}>
            ...
            >
              ...
              <Text style={styles.checkText}>Tôi đồng ý với điều khoản sử dụng</Text>
            </Pressable>
